...
def test_NonePassedInReturnsNone():
    assert Solution().addTwoNumbers(None, None) is None

def test_EitherNodeNoneReturnsNonEmptyNode():
    l1 = ListNode(1)
    l1.next = ListNode(8)
...
def test_AllSingleDigitsReturnsProperSum():
    l1 = ListNode(1)
    l1.next = ListNode(8)
    l1.next.next = ListNode(3)
    l2 = ListNode(6)
...
def test_SumMultiDigitReturnsProperSum():
    l1 = ListNode(4)
    l1.next = ListNode(8)
...
def test_SumFourDigitFromThreeDigitsReturnsProperSum():
    l1 = ListNode(1)
    l1.next = ListNode(3)
